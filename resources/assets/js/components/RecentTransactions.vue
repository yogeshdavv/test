<template>
    <div class="box">
        ...
        <div class="box__section row" v-for="transaction in transactions">
            ...
            <div class="row__column row__column--compact" :class="{ 'color-green': transaction._type == 'earning', 'color-red': transaction._type == 'spending' }">{{ currency}} {{ new Intl.NumberFormat().format(transaction.amount / 100) }}</div>
        </div>
